...
echo "load ${devtype} ${devnum} ${fdt_addr_r} ${prefix}${fdtfile}"
...
for overlay_file in ${overlays}; do
	if load {devtype} ${devnum} ${load_addr} ${prefix}allwinner/overlay/${overlay_prefix}-${overlay_file}.dtbo; then
...
if test "${overlay_error}" = "true"; then
	...
	if load ${devtype} ${devnum} ${load_addr} ${prefix}allwinner/overlay/${overlay_prefix}-fixup.scr; then
...
if load ${devtype} ${devnum} ${kernel_addr_r} ${prefix}Image; then
	echo "Load complete ${prefix}Image" 
